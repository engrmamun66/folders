<template>
  <div
    :class="{
      template_in:
        useMenuState().value.menu == 'users' &&
        useMenuState().value.subMenu == 'create',
    }"
  >
    <div class="section-title leap-admin-subheader">
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          ...
          <ul
            class="leap-admin-subheader__breadcrumbs leap-admin-nav leap-admin-nav--inline"
          >
            <li class="leap-admin-nav__item m-nav__item--home">
              <a class="leap-admin-nav__link m-nav__link--icon" href="#"
                >User</a
              >
            </li>
          ...
          <div class="leap-admin-card">
              ...
              <form>
                <div class="card-body p-0">
                  ...
                  <div class="form-group">
                    ...
                    <span
                      v-html="getRedStar('password', validators.user)"
                    ></span>
                    <input
                      type="password"
                      class="form-control"
                  ...
                  <div class="form-group">
                    ...
                    <span
                      v-html="getRedStar('company', validators.user)"
                    ></span>
                    <select class="form-control" v-model="user.company"  @change="siteMethods('getSitesByCompanyId', $event.target.value)">
                      <option
                  ...
                  <div v-if="user.role && user.role == 11" class="form-group">
                    ...
                    <select class="form-control" v-model="user.site">
                      <option
                        v-for="(site, index) in siteState.siteList"
                        :key="index"
                        :value="site.id"
                      >
                        {{ site.title }}
                  ...
                  <div v-if="user.role == 11" class="form-group">
                    ...
                    <span
                      v-html="getRedStar('deviceId', validators.user)"
                    ></span>
                    <input
                      class="form-control"
                      type="text"
            ...
            <div class="card-footer card-footer-between">
              ...
              <div class="card-footer-right">
                <button
                  type="reset"
                  class="leap-btn leap-submit-btn me-2"
                  @click="addUser()"
                >
                  Submit
                </button>
                <button
                  type="reset"
                  class="leap-btn leap-cancel-btn"
                  @click="cancel()"
                >
                  Cancel
                </button>
