<template>
  <div :class="{template_in: useMenuState().value.menu=='posts' && useMenuState().value.subMenu=='create-checkpoint'}">
          ...
          >
            ...
            <li class="leap-admin-nav__item">
              <a class="leap-admin-nav__link"
                ><span class="m-nav__link-text"> create checkpoint </span></a
              >
            </li>
          </ul>
        </div>
          ...
          <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
              <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">Add Checkpoint</h3>
